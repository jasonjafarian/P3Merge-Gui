...
function (angular, app, _) {
  ...
  module.controller('filtering', function($scope, filterSrv, $rootScope, dashboard, $location, $timeout, querySrv) {
    ...
    $scope.show_number = function(filter) {
    ...
    $scope.show_date = function(filter) {
    	  var uneditable = ['time'];
    	  if(_.contains(uneditable,filter.type)) {
    	    	return true;
    	    	}else{
